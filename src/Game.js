...
Game.prototype.SetMap = function(id) {
    ...
    map.entities = [
        ["Tree",8,2,110,2,'tree1']
        ["Tree",45,2,60, 2, "tree1"],
        ["Tree",59,2,35, 2, "tree1"],
        ["Tree",17,2,13, 2, "tree1"],
        ["Tree",33,2,13, 2, "tree1"],
        ["Tree",110,2.5,16, 2, "tree1"],
        ["Tree",107,2.5,27, 2, "tree2"],
        ["Tree",92,3.5,109, 2, "tree2"],
        ["Tree",86,3.5,107, 2, "tree2"],
        ["HealthBox", 72, 2, 52],
        ["HealthBox", 121, 1, 53],
        ["HealthBox", 69, 2.5, 18],
        ["HealthBox", 15, 3, 13],       
